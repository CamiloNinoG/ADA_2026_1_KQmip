...
class System:
    ...
    #   print(f"\n[particionar_multi_k DEBUG]")
        # print(f"  ncubos disponibles: {[c.indice for c in self.ncubos]}")
        # print(f"  dims disponibles:   {self.dims_ncubos}")
        ...
        #         if cubo:
        #             intersect = np.intersect1d(cubo.dims, np.array(mec, dtype=np.int8))
        #             print(f"    cubo {idx}: dims={cubo.dims} | intersect con mec={intersect}")
